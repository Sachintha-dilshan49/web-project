...
addToOrderBtns.forEach(addToOrderBtn =>{
  addToOrderBtn.addEventListener('click',()=>{
    numOfOrderedItem++;
    const itemName = addToOrderBtn.previousElementSibling.previousElementSibling.previousElementSibling.textContent;
    const itemPrice = addToOrderBtn.previousElementSibling.previousElementSibling.textContent;
...
// })
OrderPlusBtns = document.querySelectorAll('.order-quantity-changer') && document.querySelectorAll('.plus');
OrderMinusBtns = document.querySelectorAll('.order-quantity-changer') && document.querySelectorAll('.minus');

function refreshNeeds(){
  let OrderPlusBtns = document.querySelectorAll('.order-quantity-changer') && document.querySelectorAll('.plus');
  let OrderMinusBtns = document.querySelectorAll('.order-quantity-changer') && document.querySelectorAll('.minus');
